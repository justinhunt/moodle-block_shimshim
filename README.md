...
and you should find that this shimshim has been added to the list of
installed modules.
...
[![Build Status](https://travis-ci.org/danielneis/moodle-block_shimshim.svg?branch=master)](https://travis-ci.org/danielneis/moodle-block_shimshim)
